          ...
          <div className=" p-3 md:px-10 md:py-10 card-body">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <input
                type="submit"
                value="Sign Up"
                className="btn w-full max-w-xs text-white  btn-secondary bg-primary border-0  hover:bg-accent  transition-colors duration-500"
              />
            </form>
            <p className="text-xs md:text-sm text-accent mt-2 font-medium pl-1">
              Already have an account?
              <Link to="/login" className="text-primary font-medium pl-1">
                Please login
              </Link>
            </p>
            ...
            <button
              ...
              className=" text-accent px-4 btn btn-outline flex items-center pt-[2px] border border-primary hover:bg-primary hover:border-primary transition-colors duration-500"
            >
